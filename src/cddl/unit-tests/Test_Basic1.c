...
int main()
{
    ...
    FStar_Pervasives_Native_option___Basic1_vercdl_map18_pretty___Pulse_Lib_Slice_slice_uint8_t_
    ...
    FStar_Pervasives_Native_option___Basic1_vercdl_map42_pretty___Pulse_Lib_Slice_slice_uint8_t_
