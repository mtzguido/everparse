...
int main(void) {
  FStar_Pervasives_Native_option__CDDLTest_Test_vercdl_uint_pretty test_snd = {
    .tag = FStar_Pervasives_Native_Some,
    .v = 42L
  };
  CDDLTest_Test_vercdl_test1_pretty test = {
    .foo = 18L,
    .bar = test_snd
  };
  uint8_t out[32];
  ...
  if (! (CDDLTest_Test_validate_test1(obj)))
    return 3;
  CDDLTest_Test_vercdl_test1_pretty ret = CDDLTest_Test_parse_test1(obj);
