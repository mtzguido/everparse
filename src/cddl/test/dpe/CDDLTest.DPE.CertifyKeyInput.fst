...
requires
  rel_vercdl_certifykeyinputargs x w **
  Trade.trade (rel_vercdl_certifykeyinputargs x w) res
returns x:option (Slice.slice UInt8.t)
ensures is_slice_opt x res
{
  unfold_with_trade (`%rel_vercdl_certifykeyinputargs) (rel_vercdl_certifykeyinputargs x w);
