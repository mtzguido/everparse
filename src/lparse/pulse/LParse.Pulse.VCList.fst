module LParse.Pulse.VCList

#lang-pulse
include LParse.Spec.VCList
include LParse.Pulse.Combinators
...
let nlist_match_array
  ...
  (n: nat)
  (a: tarray)
  (l: LParse.Spec.VCList.nlist n t)
: Tot slprop
...
fn compute_remaining_size_nlist_as_array
  ...
  (n: SZ.t)
: compute_remaining_size #_ #_ (nlist_match_array varray vmatch (SZ.v n)) #_ #_ (LParse.Spec.VCList.serialize_nlist (SZ.v n) s)
=
  (arr: _)
  (#x: _)
  (out: _)
...
fn l2r_write_nlist_as_array
  ...
  (n: SZ.t)
: l2r_writer #_ #_ (nlist_match_array varray vmatch (SZ.v n)) #_ #_ (LParse.Spec.VCList.serialize_nlist (SZ.v n) s)
=
  (arr: _)
  (#x: _)
  (out: _)
...
fn compute_remaining_size_nlist_as_slice
  ...
  (n: SZ.t)
: compute_remaining_size #_ #_ (nlist_match_slice vslice vmatch (SZ.v n)) #_ #_ (LParse.Spec.VCList.serialize_nlist (SZ.v n) s)
=
  (arr: _)
  (#x: _)
  (out: _)
...
fn l2r_write_nlist_as_slice
  ...
  (n: SZ.t)
: l2r_writer #_ #_ (nlist_match_slice vslice vmatch (SZ.v n)) #_ #_ (LParse.Spec.VCList.serialize_nlist (SZ.v n) s)
=
  (arr: _)
  (#x: _)
  (out: _)
...
: l2r_writer #_ #_ (nlist_match_slice0 vmatch (n)) #_ #_ (LParse.Spec.VCList.serialize_nlist (n) s)
=
  (arr: _)
  (#x: _)
  (out: _)
