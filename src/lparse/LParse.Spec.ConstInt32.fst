module LParse.Spec.ConstInt32

(* LParse specification module for parsing 32 bits = 4 bytes unsigned constants
...
include LParse.Spec.Int32le

module U32 = FStar.UInt32
module U8 = FStar.UInt8
module Seq = FStar.Seq
module M = LParse.Math
