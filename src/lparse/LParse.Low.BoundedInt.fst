module LParse.Low.BoundedInt
open LParse.Low.Combinators
...
module E = LParse.Endianness.BitFields
module BF = LParse.BitFields
module LE = LParse.Low.Endianness
module Cast = FStar.Int.Cast

friend LParse.Spec.BoundedInt
